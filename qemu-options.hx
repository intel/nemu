...
DEF("machine", HAS_ARG, QEMU_OPTION_machine, \
    ...
    "                supported accelerators are kvm, hax, whpx or tcg (default: tcg)\n"
...
kvm, hax, whpx or tcg can be available. By default, tcg is used. If there is
...
DEF("accel", HAS_ARG, QEMU_OPTION_accel,
    ...
    "                select accelerator (kvm, hax, whpx or tcg; use 'help' for a list)\n"
